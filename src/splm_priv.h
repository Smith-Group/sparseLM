...
extern void splm_crcsm2eps(int isCRS, void *sm, int (*regions)[4], double (*colors)[3], int nregions, char *fname);
extern void splm_crsm2eps(struct splm_crsm *sm, int (*regions)[4], double (*colors)[3], int nregions, char *fname);
extern void splm_ccsm2eps(struct splm_ccsm *sm, int (*regions)[4], double (*colors)[3], int nregions, char *fname);
